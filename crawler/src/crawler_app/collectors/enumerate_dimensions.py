...
from ..utils.http_session import create_session, ensure_csrf_cookie, login_via_ajax
...
def main():
    # project root: .../crawler
    base_dir = Path(__file__).resolve().parents[3]
    data_dir = base_dir / "data"
    raw_dir = data_dir / "raw"
    os.makedirs(raw_dir.as_posix(), exist_ok=True)
    ...
    enumerate_dimensions(s, raw_dir.as_posix())
